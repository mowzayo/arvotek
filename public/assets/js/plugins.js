      ...
      t(a.animationElements).each(function () {
        ...
        if (e.length) {
          ...
          e.each(function () {
            t(this)
              .addClass("animated")
              .addClass(t(this).attr("data-animation"));
          });
        } else {
  ...
  return (function (t) {
      ...
      t.exports = function (t, e, n, d, h, y, m) {
        ...
        if (
          (L &&
            ...
            b.next &&
            (c(b, w, !0), r || "function" == typeof b[l] || u(b, l, v)),
          S &&
            O &&
            "values" !== O.name &&
            ((A = !0),
        ...
        function t(e, n) {
          ...
          if (
            ...
            p(this, "deleteAll", function () {
              var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ...
                  : "natural";
              return (
                r.addEventToQueue(r.eventNames.REMOVE_ALL, { speed: t }), r
              );
            }),
            p(this, "changeDeleteSpeed", function (t) {
              return (
                r.addEventToQueue(r.eventNames.CHANGE_DELETE_SPEED, {
                  speed: t,
                }),
                r
              );
            ...
            p(this, "changeDelay", function (t) {
              return (
                r.addEventToQueue(r.eventNames.CHANGE_DELAY, { delay: t }), r
              );
            }),
            ...
            p(this, "runEventLoop", function () {
              ...
              if (
                ...
                if (
                  !(
                    e <=
                    (i.eventName === r.eventNames.REMOVE_LAST_VISIBLE_NODE ||
                    i.eventName === r.eventNames.REMOVE_CHARACTER
                  ...
                  var u = i.eventName,
                    f = i.eventArgs;
                  switch (
                    (r.logInDevMode({ currentEvent: i, state: r.state }), u)
                  ) {
                    case r.eventNames.TYPE_CHARACTER:
                      ...
                      p
                        ? p.appendChild(v)
                        : r.state.elements.wrapper.appendChild(v),
                        (r.state.visibleNodes = c(r.state.visibleNodes).concat([
                          { type: r.visibleNodeTypes.TEXT_NODE, node: v },
                        ]));
                      break;
                    ...
                    case r.eventNames.ADD_HTML_TAG_ELEMENT:
                      ...
                      r.state.elements.wrapper.appendChild(g),
                        (r.state.visibleNodes = c(r.state.visibleNodes).concat([
                          { type: r.visibleNodeTypes.HTML_TAG, node: g },
                        ]));
                      break;
                  ...
                  r.options.loop &&
                    i.eventName !== r.eventNames.REMOVE_ALL &&
                    i.eventName !== r.eventNames.REMOVE_CHARACTER &&
                    (r.state.calledEvents = c(r.state.calledEvents).concat([
                      i,
                    ])),
    ...
    function (t, e) {
      ...
      function p() {
        f &&
          s &&
          ((f = !1), s.length ? (c = s.concat(c)) : (l = -1), c.length && v());
      }
      function v() {
        if (!f) {
          var t = a(p);
